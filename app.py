...
# initial_sidebar_state="collapsed" nasconde il menu finché non premi le 3 linette
...
# --- 3. MENU LATERALE (NAVIGAZIONE) ---
st.sidebar.markdown("## 🍼 Menu LoopBaby")
pagina = st.sidebar.radio("Scegli dove andare:", 
...
st.markdown(f"""
    <style>
    /* Nasconde barra strumenti Streamlit ma tiene le 3 linette */
...
if pagina == "Home":
    ...
    st.markdown('<div style="text-align:center; padding:0 20px; font-size:14px; color:#475569;">I capi acquistati rimarranno nell\'armadio del tuo bimbo <b>per sempre</b>.</div>', unsafe_allow_html=True)
