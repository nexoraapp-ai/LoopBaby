...
if st.session_state.pagina == "Home":
    ...
    st.markdown(f"""<div style="padding: 0 20px; font-size: 13px; color: #475569; line-height: 1.6;"><b>1. Le nostre opzioni:</b> Box Standard o Premium. <br><br><b>2. Scegli e ricevi:</b> Nel locker più vicino a te.<br><br><b>3. Controllo 48h:</b> Controlla i capi, per problemi <a href="/?nav=Contatti" target="_self" class="link-inline"><b>contattaci</b></a>.<br><br><b>4. Dopo 3 mesi:</b> Scegli se rendere o ricevere la nuova taglia.</div>""", unsafe_allow_html=True)
    ...
    if not st.session_state.edit_mode:
        ...
        with st.form("edit_f"):
            ...
            if st.form_submit_button("SALVA E BLOCCA DATI"):
                st.session_state.dati.update({"nome_genitore": n, "email": m, "telefono": t, "nome_bambino": nb, "locker": lock})
                salva_dati_su_file(st.session_state.dati); st.session_state.edit_mode = False; st.rerun()

# -- CHI SIAMO (RIFATTO CON AMORE E POSITIVITÀ) --
    ...
    st.markdown("""
        <div style="padding: 0 20px; font-size:14px; color:#475569; line-height:1.6; text-align:center;">
            Crediamo che ogni bambino sia un dono meraviglioso e vederli crescere sia l'avventura più bella della vita. <br><br>
            <b>LoopBaby</b> nasce dal desiderio di accompagnare questo viaggio con cura e intelligenza: offriamo capi di altissima qualità che ruotano di famiglia in famiglia, proprio come i racconti più belli.<br><br>
            Scegliere LoopBaby significa unirsi a una comunità che ama i propri figli e rispetta il mondo che un giorno esploreranno.
        </div>
        <div class="obiettivo-pink">
            <b style="color:#f43f5e; font-weight:800;">Il nostro obiettivo?</b><br>
            Garantire il meglio al tuo bebè, farti risparmiare tempo e denaro e proteggere il futuro del nostro pianeta.
        </div>
    """, unsafe_allow_html=True)
