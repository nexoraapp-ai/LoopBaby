...
# Logica Navigazione con Query Params per link ipertestuali
if "pagina" not in st.session_state: 
    st.session_state.pagina = "Home"

# Controllo se un link ipertestuale è stato cliccato
queryParams = st.query_params
if "p" in queryParams:
    st.session_state.pagina = queryParams["p"]

def vai(nome_pag): 
    st.session_state.pagina = nome_pag
    st.rerun()

# --- 2. CSS TOTALE (RIPRISTINO COLORI E SCHELETRO) ---
st.markdown("""
    <style>
    ...
    * { font-family: 'Lexend', sans-serif !important; }
    ...
    /* Link ipertestuale in linea */
    .inline-link { color: #475569; font-weight: 800; text-decoration: underline; cursor: pointer; }
...
if st.session_state.pagina == "Home":
    ...
    # Parola "contattaci" in grassetto e sulla stessa riga tramite link HTML
    st.markdown("""
        <div style="padding: 8px 20px; font-size: 13px; color: #475569; line-height: 1.6;">
            ...
            <b>3. Controllo 48h:</b> Controlla i capi entro 48h dalla ricezione, per qualsiasi problema <a href="/?p=Contatti" target="_self" class="inline-link"><b>contattaci</b></a>.<br><br>
