...
# Fix per errore removeChild: gestiamo il link ipertestuale in modo più sicuro
...
# --- 3. CSS BLINDATO (RIPRISTINO BARRA BLU E BEIGE) ---
st.markdown("""
    <style>
...
# RIPRISTINO HEADER BLU CON CUORE
...
if st.session_state.pagina == "Home":
    ...
    st.markdown(f"""<div style="padding: 0 20px; font-size: 13px; color: #475569; line-height: 1.6;">
            <b>1. Le nostre opzioni:</b> Box <b>Standard</b> o <b>Premium</b>. In <b>Vetrina</b>, ciò che acquisti rimane a te.<br><br>
            <b>2. Scegli e ricevi:</b> Nel locker più vicino a te.<br><br>
            <b>3. Controllo 48h:</b> Per qualsiasi problema <a href="/?nav=Contatti" target="_self" class="link-inline">contattaci</a>.<br><br>
    ...
    st.markdown("""<div class="card" style="text-align:left; font-size:13px; color:#475569; line-height:1.6;">La Box ha un costo di 19,90€ o 29,90€. Ritiro GRATUITO se rinnovi.<br><br><b>📍 Regola del 10:</b> Rendi 10 capi per riceverne 10.</div>""", unsafe_allow_html=True)
