...
# --- 2. CSS "SCHELETRO IDENTICO" + FIX LINK TESTUALE ---
st.markdown("""
    <style>
    ...
    * { font-family: 'Lexend', sans-serif !important; }
    ...
    /* FIX: Bottone che sembra un Link (Stessa dimensione del testo) */
    .stButton.link-text > button {
...
if st.session_state.pagina == "Home":
    ...
    st.markdown('<div class="link-text" style="padding-left:20px; margin-top:-5px;">', unsafe_allow_html=True)
    ...
    st.text_input("Dati Bambino", "Leonardo - 12/05/2024")
    st.markdown("<b>📍 Il tuo Locker di fiducia</b>", unsafe_allow_html=True)
    st.text_input("Indirizzo Locker", placeholder="Via Roma 10, Milano")
    st.markdown('<div class="btn-rosa">', unsafe_allow_html=True)
    if st.button("SALVA PROFILO", key="save_p"): st.success("Salvato!")
    st.markdown('</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div style="padding: 0 20px; font-size: 14px; color: #475569; line-height: 1.6; text-align: center;">Abbiamo vissuto sulla nostra pelle quanto sia impegnativo far crescere un bambino. Per questo abbiamo creato LoopBaby: per semplificarti la vita e ridurre gli sprechi.</div>', unsafe_allow_html=True)
