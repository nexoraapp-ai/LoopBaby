...
# Navigazione fluida senza errori di callback
def vai(nome_pag): 
...
# -- DETTAGLIO PROMO --
    ...
    with st.form("promo_f"):
        ...
        if st.form_submit_button("RICHIEDI ETICHETTA"): st.success("Richiesta inviata! Ti contatteremo presto.")
...
# -- PROFILO (PERFETTO CON MEMORIA E LOCKER) --
