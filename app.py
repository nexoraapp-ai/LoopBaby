...
logo_bg = get_base64("logo.jpg") # Carica l'immagine scelta per il logo panoramico
...
st.markdown(f"""
    ...
    * {{ font-family: 'Lexend', sans-serif !important; }}
    ...
    .header-text {{ color: white; font-size: 36px; font-weight: 800; letter-spacing: 3px; text-shadow: 2px 2px 8px rgba(0,0,0,0.5); }}
...
# -- INFO --
    ...
    st.markdown(f"""<div style="padding: 0 20px; font-size: 13px; color: #475569; line-height: 1.6;">
            <b>1. Le nostre opzioni:</b> Box <b>Standard</b> (usato ottimo), Box <b>Premium</b> (nuovi). In <b>Vetrina</b>, ciò che acquisti rimane a te.<br><br>
