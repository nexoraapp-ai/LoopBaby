...
# Navigazione per il link "contattaci"
...
logo_bg = get_base64("logo.png") # AGGIORNATO PER PNG

# --- 3. CSS TOTALE (BEIGE + HEADER PANORAMICO CON .PNG) ---
st.markdown(f"""
    <style>
...
if st.session_state.pagina == "Home":
    ...
    st.markdown(f"""<div style="padding: 0 20px; font-size: 13px; color: #475569; line-height: 1.6;"><b>1. Opzioni:</b> Box <b>Standard</b> (usato ottimo) o <b>Premium</b> (nuovi). In <b>Vetrina</b>, ciò che acquisti rimane a te.<br><br><b>2. Scegli e ricevi:</b> Nel locker più vicino a te.<br><br><b>3. Controllo 48h:</b> Controlla i capi, per problemi <a href="/?nav=Contatti" target="_self" class="link-inline">contattaci</a>.<br><br><b>4. Dopo 3 mesi:</b> Scegli se rendere o ricevere la nuova taglia.</div>""", unsafe_allow_html=True)
    ...
    st.markdown("""<div style="text-align:center; padding:0 20px; font-size:14px; color:#475569; margin-bottom:20px;">I capi acquistati in Vetrina rimarranno nell'armadio del tuo bimbo <b>per sempre</b>.</div>""", unsafe_allow_html=True)
