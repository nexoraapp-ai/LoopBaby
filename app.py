...
# MENU LATERALE (hamburger menu)
st.sidebar.markdown("## 🍼 LoopBaby")
pagina = st.sidebar.radio("Scegli sezione:", 
    ["Home", "Info", "Scegli la Box", "Shop Vetrina", "Mamme Fondatrici", "Il tuo Profilo", "Chi Siamo", "Contatti"])
...
# --- 3. CSS TOTALE (BEIGE + HEADER PANORAMICO + STILE SIDEBAR) ---
st.markdown(f"""
    <style>
    /* Nasconde header Streamlit ma mantiene visibili le 3 linette */
    ...
    * {{ font-family: 'Lexend', sans-serif !important; }}
    ...
    /* Pulsante 3 linette (Hamburger) in alto a SX */
...
if pagina == "Home":
    ...
    st.markdown("""<div class="promo-box"><b style="color:#E11D48; font-size:18px;">✨ Promo Mamme Fondatrici</b><br><p style="font-size:13px;">Dona 10 capi e ricevi una <b>BOX OMAGGIO</b>! Trasporto a carico nostro.</p></div>""", unsafe_allow_html=True)
    ...
    st.markdown("""<div style="padding: 0 20px; font-size: 13px; line-height: 1.6;">
            <b>1. Opzioni:</b> Box Standard o Premium.<br><br>
            <b>2. Ricevi:</b> Nel locker più vicino a te.<br><br>
            <b>3. Controllo 48h:</b> Controllaci nella sezione contatti per problemi.<br><br>
            <b>4. Dopo 3 mesi:</b> Scegli se rendere o cambiare taglia.
        </div>""", unsafe_allow_html=True)
    st.markdown('<div class="card" style="text-align:left; font-size:13px;"><b>📍 Regola del 10:</b> Rendi 10 capi per riceverne 10. Se un capo manca, vale lo scambio <b>Jeans x Jeans</b> o 5€ di penale.</div>', unsafe_allow_html=True)
    ...
    with st.form("promo"):
        ...
        if st.form_submit_button("INVIA E RICHIEDI ETICHETTA"): st.success("Richiesta inviata!")
    ...
    st.markdown("""<div style="padding: 0 20px; font-size:14px; line-height:1.7; text-align:center;">
            ...
            Proprio perché i nostri piccoli crescono così in fretta, abbiamo creato <b>LoopBaby</b>: un modo per accompagnare i loro primi passi con capi di altissima qualità, riducendo gli sprechi e rispettando il pianeta.
        </div>""", unsafe_allow_html=True)
