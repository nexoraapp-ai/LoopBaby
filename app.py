...
# --- 1. DATI FISSI ---
# Assicurati che questi dati siano corretti nella tua dashboard API
S_URL = "https://supabase.co"
S_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml6eWZ6cXlvcG1wdmlqZHRmcWZlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzczOTkzMzYsImV4cCI6MjA5Mjk3NTMzNn0.yRrzj1Op5UntjxzXsP1tY7lB3SNn3MICc6d9T0JwDWg"
...
st.markdown(f"""
    ...
    .header-t {{ color: white; font-size: 30px; font-weight: 800; }}
...
if st.session_state.user is None:
    ...
    if st.session_state.pagina == "Welcome":
        ...
        with t2:
            ...
            pr = st.text_input("Password", type="password", key="r_p")
            if st.button("CREA ACCOUNT"): registra(er, pr)
else:
    if st.session_state.pagina == "Home":
        ...
        with st.form("p"):
            ...
            if st.form_submit_button("SALVA ONLINE"): salva_db({"nome_genitore": n, "nome_bambino": nb, "taglia": tg})
