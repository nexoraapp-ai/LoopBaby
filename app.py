...
# Menu laterale inizialmente chiuso per mostrare il pulsante gigante
...
# --- 3. CSS TOTALE (BARRA LATERALE GIGANTE + BEIGE) ---
st.markdown(f"""
    <style>
    /* 1. PULSANTE 3 LINETTE GIGANTE IN ALTO A SX */
    [data-testid="stSidebarCollapsedControl"] {{
        background-color: #f43f5e !important; /* Rosa LoopBaby */
        color: white !important;
        border-radius: 50% !important;
        width: 70px !important;   /* Molto grande */
        height: 70px !important;  /* Molto grande */
        left: 20px !important;
        top: 20px !important;
        z-index: 1000000 !important;
        box-shadow: 0 4px 15px rgba(244, 63, 94, 0.6) !important;
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
    }}
    
    /* Ingrandisce l'icona interna delle 3 linette */
...
if pagina == "Home":
    ...
    st.markdown("""<div class="promo-box"><b style="color:#E11D48; font-size:18px;">✨ Promo Mamme Fondatrici</b><br><p style="font-size:13px;">Dona 10 capi e ricevi una <b>BOX OMAGGIO</b>! Trasporto incluso.</p></div>""", unsafe_allow_html=True)
    ...
    st.markdown("""<div style="padding: 0 20px; font-size: 13px; line-height: 1.6; color:#475569;">
            <b>1. Opzioni:</b> Standard o Premium.<br><br>
            <b>2. Ricevi:</b> Nel locker più vicino.<br><br>
            <b>3. Controllo 48h:</b> Contattaci per ogni necessità.<br><br>
    ...
    if not st.session_state.edit_mode:
        st.markdown(f"""<div class="card" style="text-align:left;"><b>👤 Genitore:</b> {st.session_state.dati['nome_genitore']}<br><b>📍 Locker:</b> {st.session_state.dati['locker']}</div>""", unsafe_allow_html=True)
    ...
    st.markdown("""<div style="padding: 0 20px; font-size:14px; line-height:1.7; text-align:center; color:#475569;">
            ...
            Siamo una comunità di famiglie che sceglie la condivisione per offrire il meglio ai figli.
        </div>""", unsafe_allow_html=True)
    st.markdown('<div class="obiettivo-pink"><b>Il nostro obiettivo?</b><br>Offrirti vestiti di qualità e lasciare un mondo migliore ai nostri figli.</div>', unsafe_allow_html=True)
